...
$sql_actualizar = "UPDATE cine SET id_municipio = '$municipio', nombre_cine = '$nombre', no_salas = '$salas', domicilio_cine = '$domicilio', telefono_cine = '$telefono', correo_cine = '$correo' WHERE id_cine=" . $id;
